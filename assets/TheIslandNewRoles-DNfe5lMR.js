import{u as oe,r,j as f,k as se,y as ie,l as re,c as s,f as le,b as n,d as c,w as M,p as F,t as o,n as B,v as he,F as G,e as ce,i as de,z as ue,h as me,A as ye,o as i,_ as fe}from"./index-CixHVENj.js";import{k as X}from"./marked.esm-B5D8JARp.js";import{n as ge}from"./TheIslandNavbar-DR_MX-82.js";/* empty css                                                                        */const pe=`## Overview & Lore
...
Requests that were denied or ignored are not mentioned.`,Te=`## Overview & Lore
...
- \`BARD played Harmonize to boost the morale of PLAYER X\``,Ae=`## Overview & Lore
...
- \`BLACKSMITH voted for PLAYER X\``,ve=`## Overview & Lore
...
- \`BUILDER voted for PLAYER X\``,Ee=`## Overview & Lore
...
- \`CHEMIST voted for PLAYER X\``,be=`## Overview & Lore
...
- \`COOK voted for PLAYER X\``,Re=`## Overview & Lore
...
- \`FARMER voted for PLAYER X\``,Se=`## Overview & Lore
...
The Luminous Seashell target is only revealed through Interrogator-only previous-day information, not through the global announcement.`,we=`## Overview & Lore
...
- \`GURU voted for PLAYER X\``,Pe=`## Overview & Lore
...
- \`HUNTER voted for PLAYER X\``,Le=`## Overview & Lore
...
- \`INTERROGATOR voted for PLAYER X\``,Ce=`## Overview & Lore
...
- \`JAILOR voted for PLAYER X\``,ke=`## Overview & Lore
...
- \`MEDIC poisoned PLAYER Y from the North West\``,He=`## Mimic Ability
...
No Extra Action can be taken with this Secret Role.`,Oe=`## Description
...
- This cannot be used on the same night as **Bodyguard** (since Bodyguard replaces directional watching).`,Me=`## Overview & Lore
...
- \`PRIEST voted for PLAYER X\``,Be=`## Overview & Lore
...
- \`SCAVENGER voted for PLAYER X\``,De=`---
tags:
  - "#Artisans"
---
## Overview & Lore
...
- \`TEACHER voted for PLAYER X\``,Ye=`## Overview
...
No Extra Action can be taken with this Secret Role.`,Fe=`## Overview
...
No Extra Action can be taken with this Secret Role.`,Ge=`# Keyword: HELP

# Help Needed?
I would be very careful asking for help.

Your access is limited as the games are happening.

Unfortunately, I cannot help you now. 

Don't let anyone know of this file, search back later for 

\`incursion\``,Xe={class:"roles-page"},xe={class:"roles-hero"},We={class:"hero-panel"},Ue={class:"search-row"},_e={class:"meta-row"},qe={class:"command-panel"},Ke={class:"roles-layout"},Je={class:"role-library","aria-label":"Role library"},Ve={class:"library-head"},je={class:"role-list"},ze={key:0,class:"empty-state"},$e={key:1,class:"empty-state danger-state"},Qe=["onClick"],Ze=["title"],en={class:"role-card-copy"},nn={key:0},tn={key:3,class:"empty-state"},an={class:"role-reader"},on={key:0,class:"role-document"},sn={class:"document-hero"},rn={class:"role-type"},ln={key:0,class:"role-flavor"},hn=["innerHTML"],cn={key:1,class:"empty-state"},dn={class:"command-window",role:"dialog","aria-modal":"true","aria-label":"Secure command prompt"},un={class:"command-window-body"},mn={class:"command-row"},yn={key:0,class:"secret-dossier"},fn={class:"secret-head"},gn={class:"secret-terminal"},pn={class:"secret-terminal-line muted"},Tn={key:0,class:"cursor"},An=oe({__name:"TheIslandNewRoles",setup(vn){const x=Object.assign({"../data/roles-md/Assassin.md":pe,"../data/roles-md/Bard.md":Te,"../data/roles-md/Blacksmith.md":Ae,"../data/roles-md/Builder.md":ve,"../data/roles-md/Cannibal-secret.md":Ee,"../data/roles-md/Chemist.md":Ie,"../data/roles-md/Cook.md":be,"../data/roles-md/Farmer.md":Re,"../data/roles-md/Fisher.md":Se,"../data/roles-md/Guru.md":we,"../data/roles-md/Hunter.md":Pe,"../data/roles-md/Interrogator.md":Le,"../data/roles-md/Jailor.md":Ce,"../data/roles-md/Medic.md":ke,"../data/roles-md/Mimic-secret.md":He,"../data/roles-md/Nightguard.md":Oe,"../data/roles-md/Priest.md":Me,"../data/roles-md/Scavenger.md":Be,"../data/roles-md/Tailor.md":De,"../data/roles-md/Teacher.md":Ne,"../data/roles-md/Werewolf-secret.md":Ye,"../data/roles-md/Wizard-secret.md":Fe}),W=Object.assign({"../data/sdf/Help-EE.md":Ge}),l=r([]),E=r([]),g=r("Assassin"),p=r(""),w=r(""),d=r("Awaiting clearance keyword."),m=r(""),T=r(""),P=r(!1),L=r(!1),D=r(null),I=r("All"),y=r("idle"),C=r("");let b=null;X.use({gfm:!0,breaks:!1});const U=f(()=>l.value.filter(t=>t.roleType==="Normal").length),_=f(()=>l.value.filter(t=>t.roleType==="Secret").length),A=f(()=>{const t=p.value.trim().toLowerCase();return l.value.filter(e=>I.value!=="All"&&e.roleType!==I.value?!1:t?[e.name,e.roleType,e.summary,e.searchableText].join(" ").toLowerCase().includes(t):!0)}),h=f(()=>{const t=A.value.find(e=>e.id===g.value);return t||(A.value[0]??l.value[0]??null)}),k=f(()=>!!R.value),R=f(()=>m.value?E.value.find(t=>t.id===m.value)??null:null);se(q),ie(v),re(h,()=>{v(),T.value="",m.value="",d.value="Awaiting clearance keyword."});async function q(){y.value="loading",C.value="";try{const t=await Promise.all(Object.entries(x).map(([e,a])=>K(e,a)));l.value=t.sort((e,a)=>e.name.localeCompare(a.name)),E.value=await Promise.all(Object.entries(W).map(([e,a])=>Z(e,a))),y.value="ready",l.value.some(e=>e.id===g.value)||(g.value=l.value[0]?.id??"")}catch(t){y.value="error",C.value=t instanceof Error?t.message:String(t)}}async function K(t,e){const a=t.split("/").pop()?.replace(/\.md$/,"")??"role",u=Q(e,a),H=ee(e),O=await X.parse(e);return{id:a,name:u,roleType:a.toLowerCase().endsWith("-secret")?"Secret":"Normal",summary:H,markdown:e,html:O,searchableText:ne(e)}}function J(t){g.value=t}function V(){p.value=""}async function j(){L.value=!0,d.value=E.value.length?"Awaiting clearance keyword.":"No encrypted extensions found.",await ye(),D.value?.focus()}function N(){L.value=!1}function Y(){const t=w.value.trim().toLowerCase(),e=E.value.find(a=>a.keyword.toLowerCase()===t);if(!t){d.value="Access denied. Empty command rejected.",m.value="";return}if(e){m.value=e.id,d.value=`Clearance accepted. ${e.name} decrypted.`,z(e.text);return}v(),T.value="",m.value="",d.value="Access denied. Keyword rejected."}function z(t){v(),T.value="",P.value=!0;let e=0;b=setInterval(()=>{T.value+=t.charAt(e),e+=1,e>=t.length&&v()},12)}function v(){b&&(clearInterval(b),b=null),P.value=!1}function $(t){return t.name.trim().charAt(0).toUpperCase()||"?"}function Q(t,e){const a=t.match(/^---[\s\S]*?\nname:\s*(.+?)\n[\s\S]*?---/)?.[1];return a?S(a).trim():e.replace(/-secret$/i,"").replace(/([a-z])([A-Z])/g,"$1 $2").split(/[-_\s]+/).filter(Boolean).map(u=>u.charAt(0).toUpperCase()+u.slice(1).toLowerCase()).join(" ")}async function Z(t,e){const a=t.split("/").pop()?.replace(/\.md$/,"")??"",u=a,H=a,O=e.match(/^#\s*Keyword:\s*(.+)$/im)?.[1]?.trim()??"",ae=e.replace(/^#\s*Keyword:\s*.+$/im,"").trim();return{id:u,name:H,keyword:O,text:te(ae)}}function ee(t){return t.replace(/^#{1,6}\s+.+$/gm,"").split(/\n\s*\n/).map(a=>S(a).trim()).find(a=>a&&!a.startsWith("---"))??""}function ne(t){return S(t).replace(/\s+/g," ").trim()}function te(t){return S(t).split(`
`).map(e=>e.trimEnd()).join(`
`).replace(/\n{3,}/g,`

`).trim()}function S(t){return t.replace(/`([^`]+)`/g,"$1").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\*([^*]+)\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/^[-*]\s+/gm,"").replace(/^#{1,6}\s+/gm,"")}return(t,e)=>(i(),s(G,null,[le(ge),n("div",Xe,[n("header",xe,[e[5]||(e[5]=n("div",{class:"hero-copy"},[n("p",{class:"eyebrow"},"Classified Island Archive"),n("h1",null,"Role Dossiers"),n("p",null," Authorized terminal access for role mechanics, covert procedures, public announcements, and host-facing intelligence files. ")],-1)),n("div",We,[e[3]||(e[3]=n("div",{class:"terminal-bar"},[n("span"),n("span"),n("span"),n("strong",null,"SECURE QUERY")],-1)),e[4]||(e[4]=n("label",{for:"role-search"},"Search classified files",-1)),n("div",Ue,[M(n("input",{id:"role-search","onUpdate:modelValue":e[0]||(e[0]=a=>p.value=a),class:"search",type:"text",placeholder:"Search poison, Machete, Secret Role...",spellcheck:"false"},null,512),[[F,p.value]]),p.value?(i(),s("button",{key:0,class:"clear-btn",type:"button",onClick:V}," Clear ")):c("",!0)]),n("div",_e,[n("span",null,o(A.value.length)+" visible",1),n("span",null,o(U.value)+" normal",1),n("span",null,o(_.value)+" secret",1)]),n("div",qe,[n("button",{class:"command-launch",type:"button",onClick:j}," Access Command Prompt "),n("p",{class:B(["command-status",{unlocked:k.value}])},o(d.value),3)])])]),n("main",Ke,[n("aside",Je,[n("div",Ve,[n("div",null,[e[6]||(e[6]=n("span",null,"Archive Index",-1)),n("strong",null,o(l.value.length)+" files",1)]),M(n("select",{"onUpdate:modelValue":e[1]||(e[1]=a=>I.value=a),class:"type-filter","aria-label":"Filter role type"},e[7]||(e[7]=[n("option",{value:"All"},"All",-1),n("option",{value:"Normal"},"Normal",-1),n("option",{value:"Secret"},"Secret",-1)]),512),[[he,I.value]])]),n("div",je,[y.value==="loading"?(i(),s("div",ze," Loading classified index... ")):y.value==="error"?(i(),s("div",$e,o(C.value),1)):(i(!0),s(G,{key:2},ce(A.value,a=>(i(),s("button",{key:a.id,type:"button",class:B(["role-card",{active:a.id===g.value}]),onClick:u=>J(a.id)},[n("span",{class:"role-mark",title:`${a.name} icon`},o($(a)),9,Ze),n("span",en,[n("strong",null,o(a.name),1),n("small",null,o(a.roleType)+" Dossier",1),a.summary?(i(),s("em",nn,o(a.summary),1)):c("",!0)])],10,Qe))),128)),y.value==="ready"&&!A.value.length?(i(),s("div",tn," No roles match your search. ")):c("",!0)])]),n("section",an,[h.value?(i(),s("article",on,[n("div",sn,[n("div",null,[n("p",rn,o(h.value.roleType)+" Dossier",1),n("h2",null,o(h.value.name),1),h.value.summary?(i(),s("p",ln,o(h.value.summary),1)):c("",!0)])]),h.value.html?(i(),s("div",{key:0,class:"markdown-body",innerHTML:h.value.html},null,8,hn)):c("",!0)])):(i(),s("div",cn," Select a role to view details. "))])]),L.value?(i(),s("div",{key:0,class:"command-overlay",onClick:de(N,["self"])},[n("section",dn,[n("div",{class:"command-window-bar"},[e[8]||(e[8]=n("div",{class:"terminal-bar command-window-dots"},[n("span"),n("span"),n("span"),n("strong",null,"ISLAND SECURE SHELL")],-1)),n("button",{class:"command-close",type:"button",onClick:N}," CLOSE ")]),n("div",un,[e[12]||(e[12]=n("p",{class:"command-window-label"}," Island encrypted extension console ",-1)),n("div",mn,[e[9]||(e[9]=n("span",{class:"command-prefix"},"island://secure>",-1)),M(n("input",{ref_key:"commandInput",ref:D,"onUpdate:modelValue":e[2]||(e[2]=a=>w.value=a),class:"command-input",type:"text",placeholder:"Enter clearance keyword...",spellcheck:"false",onKeyup:ue(Y,["enter"])},null,544),[[F,w.value]]),n("button",{class:"clear-btn",type:"button",onClick:Y}," Execute ")]),n("p",{class:B(["command-status",{unlocked:k.value}])},o(d.value),3),k.value&&R.value?(i(),s("section",yn,[n("div",fn,[e[10]||(e[10]=n("p",null,"Encrypted Extension",-1)),n("h3",null,o(R.value.name),1)]),n("div",gn,[n("div",pn," island://secure> decrypt "+o(R.value.name),1),e[11]||(e[11]=n("div",{class:"secret-terminal-line"}," ACCESS GRANTED. STREAMING DECRYPTED PAYLOAD... ",-1)),n("pre",null,[me(o(T.value),1),P.value?(i(),s("span",Tn,"_")):c("",!0)])])])):c("",!0)])])])):c("",!0)])],64))}}),Sn=fe(An,[["__scopeId","data-v-709eb77c"]]);export{Sn as default};
